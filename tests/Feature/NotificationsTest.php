...
class NotificationsTest extends TestCase
{
    ...
    function a_user_can_fetch_their_unread_notifications()
    {
        ...
        $this->assertCount(
            1,
            $this->getJson(route('user-notifications', auth()->user()->username))->json()
        );
    }
    ...
    function a_user_can_mark_a_notification_as_read()
    {
        ...
        tap(auth()->user(), function ($user) {
            ...
            $this->delete(route('user-notification.destroy', [$user->username, $user->unreadNotifications->first()->id]));
